...
exports.sendVerificationCode = async (req, res) => {
  ...
  try {
    ...
    //can also use node js crypto module to generate code
    ...
    res.status(400).json({ success: false, message: 'Code failed to send!' });
  } catch (error) {
    console.log(error);
  }
};
...
exports.verifyVerificationCode = async (req, res) => {
  ...
  try {
    ...
    if (
      ...
      return res
        .status(400)
        .json({ success: false, message: 'Oops something is broken!' });
    }
